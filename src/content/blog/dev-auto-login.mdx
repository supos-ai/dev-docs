...
- 下载 <a download='auto-login.html' href="/static/html/autoLogin.html">自动登录文件附件 </a> ，无需修改，直接上传到目标平台 App 的静态资源中，可以是任意 App，路径没有限制，也可以直接放在静态资源根目录中，建议新建 App 并命名为自动登录方便查找
